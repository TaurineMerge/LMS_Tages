...
INSERT INTO knowledge_base.course_b (id, category_id, title, description, level, visibility, created_at, updated_at) VALUES ('b1000002-0000-4000-8000-000000000001', 'a1000000-0000-4000-8000-000000000001', 'Advanced Go Concurrency', 'Dive deep into Go''s powerful concurrency model, including goroutines, channels, and the select statement for complex coordination.', 'hard', 'private', '2024-02-01 09:00:00', '2024-02-01 09:00:00');
INSERT INTO knowledge_base.lesson_d (id, course_id, title, content, created_at, updated_at) VALUES

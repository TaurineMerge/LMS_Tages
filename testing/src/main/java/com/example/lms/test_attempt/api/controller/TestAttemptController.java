...
public class TestAttemptController {
    ...
    public void getAllTestAttempts(Context ctx) {
        try {
            ...
            List<Test_AttemptModel> attempts = testAttemptService.getAllTestAttempts();
    ...
    public void getTestAttemptById(Context ctx) {
        try {
            ...
            Test_AttemptModel attempt = testAttemptService.findById(id)
                    .orElse(null);
    ...
    public void getTestAttemptsByStudentId(Context ctx) {
        try {
            ...
            List<Test_AttemptModel> attempts = testAttemptService.getTestAttemptsByStudentId(studentId);
            List<TestAttempt> dtos = attempts.stream()
                    .map(this::toDTO)
                    .collect(Collectors.toList());
    ...
    public void getTestAttemptsByTestId(Context ctx) {
        try {
            ...
            List<Test_AttemptModel> attempts = testAttemptService.getTestAttemptsByTestId(testId);
            List<TestAttempt> dtos = attempts.stream()
                    .map(this::toDTO)
                    .collect(Collectors.toList());
    ...
    public void getTestAttemptsByDate(Context ctx) {
        try {
            ...
            List<Test_AttemptModel> attempts = testAttemptService.getTestAttemptsByDate(date);
            List<TestAttempt> dtos = attempts.stream()
                    .map(this::toDTO)
                    .collect(Collectors.toList());
     ...
     * POST /test-attempts
     * 
     * Примечание: Для создания попытки нужны дополнительные поля (studentId, testId, attemptVersion),
    ...
    public void createTestAttempt(Context ctx) {
        try {
            ...
            Test_AttemptModel attempt = new Test_AttemptModel(
            ...
            Test_AttemptModel savedAttempt = testAttemptService.updateTestAttempt(attempt);
    ...
    public void updateTestAttempt(Context ctx) {
        try {
            ...
            Test_AttemptModel existingAttempt = testAttemptService.findById(id)
                    .orElse(null);
            ...
            Test_AttemptModel updatedAttempt = new Test_AttemptModel(
            ...
            Test_AttemptModel savedAttempt = testAttemptService.updateTestAttempt(updatedAttempt);
            TestAttempt responseDto = toDTO(savedAttempt);
    ...
    public void getCompletedTestAttempts(Context ctx) {
        try {
            ...
            List<Test_AttemptModel> attempts = testAttemptService.getCompletedTestAttempts();
            List<TestAttempt> dtos = attempts.stream()
                    .map(this::toDTO)
                    .collect(Collectors.toList());
    ...
    public void getIncompleteTestAttempts(Context ctx) {
        try {
            ...
            List<Test_AttemptModel> attempts = testAttemptService.getIncompleteTestAttempts();
            List<TestAttempt> dtos = attempts.stream()
                    .map(this::toDTO)
                    .collect(Collectors.toList());
    ...
    public void getBestAttemptByStudentAndTest(Context ctx) {
        try {
            String studentIdParam = ctx.pathParam("studentId");
            String testIdParam = ctx.pathParam("testId");
            logger.info("Получение лучшей попытки студента {} по тесту {}", studentIdParam, testIdParam);
            
            UUID studentId = UUID.fromString(studentIdParam);
            UUID testId = UUID.fromString(testIdParam);
            
            Test_AttemptModel bestAttempt = testAttemptService
            ...
            if (bestAttempt == null) {
                ...
                logger.warn("Лучшая попытка студента {} по тесту {} не найдена", studentId, testId);
                return;
            }
            ...
            ctx.json(dto);
            ctx.status(HttpStatus.OK);
            logger.info("Возвращена лучшая попытка студента {} по тесту {}", studentId, testId);
    ...
    public void getAttemptsByStudentAndTest(Context ctx) {
        try {
            ...
            List<Test_AttemptModel> attempts = testAttemptService.getAttemptsByStudentAndTest(studentId, testId);
            List<TestAttempt> dtos = attempts.stream()
                    .map(this::toDTO)
                    .collect(Collectors.toList());
    ...
    public void completeTestAttempt(Context ctx) {
        try {
            ...
            Test_AttemptModel updatedAttempt = testAttemptService.getTestAttemptById(id);
     ...
     */
    private TestAttempt toDTO(Test_AttemptModel attempt) {

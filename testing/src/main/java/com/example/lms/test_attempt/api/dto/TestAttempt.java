 ...
 * {@code Test_AttemptModel}, предназначенное только для коммуникации
...
public class TestAttempt implements Serializable {
    ...
    /** Строковое представление результата (например: "passed", "failed", "incomplete"). */
    private String result;

    /**
     * Пустой конструктор необходим для сериализации и десериализации (Jackson/Javalin).
     */
    public TestAttempt() {
    }

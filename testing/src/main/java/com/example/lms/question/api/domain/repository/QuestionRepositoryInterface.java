...
public interface QuestionRepositoryInterface {
     ...
     *
     * @param question модель вопроса с обновлёнными данными (id должен быть заполнен)
    ...
    /**
     * Удалить все вопросы, принадлежащие указанному тесту.
     *
    ...
    /**
     * Проверить существование вопроса по его ID.
     *
     * @param id идентификатор вопроса
     ...
     *
     * @param testId   идентификатор теста
     * @param fromOrder порядок, с которого начинать сдвиг (ожидается неотрицательный)
